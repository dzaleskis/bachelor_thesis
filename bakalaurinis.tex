...
kas įprastai užtrunka 10-20 ciklų.
...
Tiesa, rikiuojant sudėtingus duomenų tipus variantas su Ciura tarpų seka turėtų gauti palankesnius rezultatus, kadangi atlieka mažiau operacijų.
...
Pirmiausia reikėtų išnagrinėti, nuo ko priklauso šakų neatspėjimo santykis naudojant skirtingas tarpų sekas.
...
Pirmiausia pastebėsime, jog rikiavimas įterpimu yra vienas palankiausių $O(n^2)$ algoritmų šakų nuspėjimui
...
o kita šaka priklauso nuo elementų palyginimo rezultato (sunkiai nuspėjama).
...
Pastebėsime, jog tarpų sekų $\{48, 1\}$ ir $\{32, 1\}$ pirmo perėjimo šakos nuspėjamumas yra geresnis, kadangi
vidinis ciklas visada atliks daugiausia vieną iteraciją ir iš esmės priklausys nuo elementų palyginimo, tuo tarpu sekos $\{16, 1\}$
pirmo perėjimo nuspėjamumas yra prastesnis, kadangi priklausomai nuo išorinio ciklo iteracijos vidinis ciklas daugiausia atliks nuo 1 iki 3 iteracijų.
Taip pat galime pastebėti, jog tarpų sekų $\{48, 1\}$ ir $\{32, 1\}$ šakų nuspėjamumo rezultatai yra geresni, nes jos pirmame perėjime
...
Reikia pastebėti, jog atliekant perėjimą su tarpu $h$, kur $h > \lfloor\frac{N}{2}\rfloor$, vidiniame cikle galima praleisti
indekso išėjimo už ribų tikrinimą $j \ge h$, kadangi maksimalus iteracijų skaičius vidiniame cikle bus 1.
...
Paminėsime, jog burbuliuko perėjimas atlieka būtent tai, kadangi jis neturi vidinio ciklo.
...
% galima parasyt apie unguarded selo algoritma, kuri galima naudot hibriduose 
