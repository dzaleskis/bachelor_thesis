...
% Atliekant eksperimentus buvo pastebėta, jog mažiausiai Šelo algoritmo variantams palankūs yra atsitiktiniai duomenų rinkiniai.
% Tuo pačiu pastebėti šiek tiek palankesni rezultatai naudojant atsitiktinį duomenų rinkinį, turintį didelį dublikatų skaičių.
% Labiausiai palankūs buvo dalinai išrikiuoti duomenų rinkiniai.

% Darbo metu sugeneruoti Šelo algoritmai gana reikšmingai skiriasi nuo literatūroje pateikiamų variantų.
% Tai galima paaiškinti tuo, jog daug didesnis dėmesys buvo skirtas jų veikimo laikui, tad sugeneruoti variantai naudoja trumpesnes tarpų sekas ir
% jų gretimų tarpų skirtumai yra didesni.
% Siekiant minimizuoti veikimo laiką
